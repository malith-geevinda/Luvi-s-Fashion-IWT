...
<html>
    <head>
        <title>Reset Password-LuVi's fashion</title>
    ...
    <body>
        ...
        <fieldset>
            <p>Forgot password? Please Enter your Email address. We will send you a link via Email to create a new password.</p>
            <br>
            <input type = "email" id = "Eml" name = "EmlAdd" placeholder = "abc@gmail.com" pattern = "[a-z0-9]+ @ [a-z0-9]+\.[a-z]{2,3}" required ></p><br>
